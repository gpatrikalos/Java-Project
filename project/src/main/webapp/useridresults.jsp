...
<html>
    ...
    <body>
        <FORM NAME="form9" action="index.jsp" METHOD="POST" >
         <p align="center"> <h2>Αποτελέσματα για κωδικού εξεταζόμενου </h2></p>       
          <INPUT TYPE="text" NAME="answertext11" value="" style="margin-left:auto;margin-right:auto;display:block;margin-top:10%;margin-bottom:0%">
          ...
          <input type="hidden" name="userresult" value="que1" style="margin-left:auto;margin-right:auto;display:block;margin-top:10%;margin-bottom:0%" />
    </FORM>
