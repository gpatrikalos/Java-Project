...
<html>
    ...
    <body>
        <FORM NAME="form9" action="index.jsp" METHOD="POST" >
         <p align="center"> <h2>Αποτελέσματα ανά εξεταστικό κέντρο (Με βάση ημερομηνία)</h2></p>       
          <INPUT TYPE="text" NAME="answertext9" value="" style="margin-left:auto;margin-right:auto;display:block;margin-top:10%;margin-bottom:0%">
          ...
          <input type="hidden" name="cresult" value="que1" style="margin-left:auto;margin-right:auto;display:block;margin-top:10%;margin-bottom:0%" />
    </FORM>
