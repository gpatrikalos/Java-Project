...
<html>
    ...
    <body>
        <FORM NAME="form9" action="index.jsp" METHOD="POST" >
         <p align="center"> <h2>Αποτελέσματα ανά εξέταση </h2></p>       
          <INPUT TYPE="text" NAME="answertext10" value="" style="margin-left:auto;margin-right:auto;display:block;margin-top:10%;margin-bottom:0%">
          ...
          <input type="hidden" name="eresult" value="que1" style="margin-left:auto;margin-right:auto;display:block;margin-top:10%;margin-bottom:0%" />
    </FORM>
