    ...
    <body onload="Confirm();">
        ...
        <% 
               ...
               if(session.getAttribute("isloggedin").equals("YES") && session.getAttribute("role").equals("3"))
               {
                  ...
                  out.println ("<tr>");
                  out.println("<th>");
                  out.println(les1.get(1).getDescr());
                  out.println("</th>");
                  out.println("</tr>");
                  ...
                  out.println ("<tr>");
                  out.println("<th>");
                  out.println(les1.get(1).getAnsw1());
                  out.println("</th>");
                  out.println("</tr>");
                  
                  out.println ("<tr>");
                  out.println("<th>");
                  out.println(les1.get(1).getAnsw2());
                  out.println("</th>");
                  out.println("</tr>");
                  
                  out.println ("<tr>");
                  out.println("<th>");
                  out.println(les1.get(1).getAnsw3());
                  out.println("</th>");
                  out.println("</tr>");
                  
                  out.println ("<tr>");
                  out.println("<th>");
                  out.println(les1.get(1).getAnsw4());
                  out.println("</th>");
                  out.println("</tr>");
        ...
        <INPUT TYPE="text" NAME="answertext22" value="" style="margin-left:auto;margin-right:auto;display:block;margin-top:10%;margin-bottom:0%">
        ...
        <input type="hidden" name="tanswer2" value="que2" style="margin-left:auto;margin-right:auto;display:block;margin-top:10%;margin-bottom:0%" />
    </FORM>
    </body>
</html>
